  ...
  <body>
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bold ms-3">Erp Sales</span>
            </a>
    ...
    <a href="{{ url('home') }}" class="menu-link">
              ...
              <a href="" class="menu-link">
                <i class="menu-icon icon-base ti tabler-smart-home"></i>
                <div data-i18n="Dashboards">User Role</div>
              </a> -->
    ...
    <a href="{{ url('roles') }}" class="menu-link">
              ...
              <li class="menu-item {{ request()->is('team') ? 'active open' : '' }}">
    <a href="{{ url('team') }}" class="menu-link">
                <i class="menu-icon icon-base ti tabler-brand-teams"></i>
                <div data-i18n="Dashboards">Team</div>
              </a>
              <li class="menu-item {{ request()->is('lead') ? 'active open' : '' }}">
    <a href="{{ url('lead') }}" class="menu-link">
                <i class="menu-icon icon-base ti tabler-device-ipad-star"></i>
